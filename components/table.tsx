...
import { saveIncidencia } from '@/api/incidenciasCrud';
...
export default function FullFeaturedCrudGrid({INCIDENCIAS, TIPO_INCIDENCIAS, ALUMNOS, PROFESORES}: Props) {
